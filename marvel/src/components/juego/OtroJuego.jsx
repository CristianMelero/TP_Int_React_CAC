    ...
    <>
       ...
       <h2>¿Cuál de estos dos Avengers tiene más poderes?</h2>
            <form onSubmit={submitHandler}>
				...
				<p><img className="solo_imagen_compu" src={data[avenger1].Image_Link} alt="Compu"></img></p>
				</div>
				</div>
				</div>
				...
				<div className="tarjeta_equipos_imagen">
				<p><img src={data[avenger2].Image_Link} alt="Usuario"></img></p>
				</div>
				</div>
				</div>
				</div>
                ...
                <br /><br />
                <button type="submit"><h4><p><img src="../start.png" alt="Botón Start Game" width="100"></img></p></h4></button>
                </div>
